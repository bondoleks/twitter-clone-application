...
export const Retweet = ({ tweet }) => {
    ...
    return (
      <Box data-user_id={user_id} data-tweet_id={id} sx={{ display: 'flex', cursor: 'pointer',border: '1px solid grey',borderRadius: '16px',mt:'14px',':hover': { backgroundColor: 'rgba(0,0,0, 0.1)' } }}
      onClick={(e) => {
        e.stopPropagation();
        navigate(`/tweet/${id}`)}}
      >
