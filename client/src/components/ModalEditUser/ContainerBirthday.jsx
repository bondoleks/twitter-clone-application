...
//     const handleDayChange = (event) => {
//         setDay(event.target.value);
//         updateBirthday(event.target.value, month, year); // Вызов функции для обновления состояния "birthday"
//       };
      
//       const handleMonthChange = (event) => {
//         setMonth(event.target.value);
//         updateBirthday(day, event.target.value, year); // Вызов функции для обновления состояния "birthday"
//       };
      
//       const handleYearChange = (event) => {
//         setYear(event.target.value);
//         updateBirthday(day, month, event.target.value); // Вызов функции для обновления состояния "birthday"
//       };
      
//       const updateBirthday = (day, month, year) => {
